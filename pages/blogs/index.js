      ...
      <section class="flex flex-row flex-wrap mx-auto">
        {[1, 2, 3, 4, 5, 6].map((item, index) => {
          return (
            ...
            >
              <div class="flex flex-col items-stretch min-h-full pb-4 mb-6 transition-all duration-150 bg-gradient-to-r from-themeColor to-secondTheme rounded-lg shadow-lg hover:shadow-2xl">
